...
RSCoutputDir = '../HTMl/RSCHTML'
ACSoutputDir = '../HTMl/ACSHTML'
...
with open("asc.cu.dois") as file:
    ...
    for item in content:
        ...
        if site == "pubs.rsc.org":
            ...
            #complete_path = os.path.join(RSCoutputDir, filename + ".html")
            #with open(complete_path, "w") as htmlfile:
             #   htmlfile.write(source)
        elif site == 'pubs.acs.org':
            source = driver.page_source
            complete_path = os.path.join(ACSoutputDir, filename + ".html")
            with open(complete_path, "w") as htmlfile:
                htmlfile.write(source)
